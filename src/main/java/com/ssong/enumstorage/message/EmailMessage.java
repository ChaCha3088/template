package com.ssong.enumstorage.message;
...
public enum EmailMessage {
    ...
    VERIFICATION_EMAIL_LINK1("<a href=https://localhost:8080/auth/member/verification-email/"),
    ...
    CHANGE_PASSWORD_EMAIL_LINK1("<a href=https://localhost:8080/auth/member/change-password/"),
